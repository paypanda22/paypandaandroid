...
import app.pay.retailers.adapters.CountryListAdapter
import app.pay.retailers.adapters.StateListAdapter
import app.pay.retailers.databinding.FragmentPersonalDetailsBinding
...
import app.pay.retailers.responsemodels.aadhaarAddress.AadhaarAddressResponse
import app.pay.retailers.responsemodels.countrylist.CountryListResponse
...
class PersonalDetailsFragment : BaseFragment<FragmentPersonalDetailsBinding>(FragmentPersonalDetailsBinding::inflate) {
    ...
    private fun openStateListDialog() {
        ...
        val clickListner = object : StateListClickListner {
            override fun onItemClicked(holder: RecyclerView.ViewHolder, model: List<app.pay.retailers.responsemodels.statelist.Data>, pos: Int) {
