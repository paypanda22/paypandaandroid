...
import app.pay.retailers.databinding.FragmentFragemntNetworkBinding
...
import app.pay.retailers.interfaces.DownStreamClick
...
import app.pay.retailers.responsemodels.downstramdistributer.DonwStreamDistributerResponse
import app.pay.retailers.responsemodels.downstreamRetailerResponse.DownstreamRetailarResp
import app.pay.retailers.responsemodels.downstreamresponse.Data
import app.pay.retailers.responsemodels.downstreamresponse.DownstreamResponse
...
class FragemntNetwork : BaseFragment<FragmentFragemntNetworkBinding>(FragmentFragemntNetworkBinding::inflate) {
    ...
    private lateinit var downstramlistRetailer:MutableList<app.pay.retailers.responsemodels.downstreamRetailerResponse.Data>
    private lateinit var downstramlistDistributer:MutableList<app.pay.retailers.responsemodels.downstramdistributer.Data>
    private var page = "0"
                    ...
                    if (!response.error) {
                        if (response.statusCode == 200) {
                            ...
                            val clickListner = object : DownStreamClick {
                                override fun onItemClicked(holder: DownStreamAdapter.ViewHolder, downstramlist: MutableList<Data>, position: Int, callback: (List<app.pay.retailers.responsemodels.downstreamRetailerResponse.Data>) -> Unit) {
                            ...
                            if (response.data.isNotEmpty()) {
                                ...
                                val clickListner = object : DownStreamRetailerClick {
                                    override fun onTransferMoneyClicked(
                                        ...
                                        downstramlistDistributer: MutableList<app.pay.retailers.responsemodels.downstramdistributer.Data>,
                                        position: Int
                                    ) {
