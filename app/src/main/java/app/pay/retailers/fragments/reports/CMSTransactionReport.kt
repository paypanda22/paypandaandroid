...
import app.pay.retailers.adapters.CMSReportAdapter
import app.pay.retailers.databinding.FragmentCMSTransactionReportBinding
...
import app.pay.retailers.responsemodels.cmsreportresponse.CMSReportResponse
...
class CMSTransactionReport : BaseFragment<FragmentCMSTransactionReportBinding>(FragmentCMSTransactionReportBinding::inflate) {
    ...
    private lateinit var cmslist:MutableList<app.pay.retailers.responsemodels.cmsreportresponse.Data>
    override fun init() {
        nullActivityCheck()
                    ...
                    if (response.data.isNotEmpty()) {
                        ...
                        val clickListner = object : CMSInvoicClick {
                            override fun onItemClicked(
                                ...
                                model: List<app.pay.retailers.responsemodels.cmsreportresponse.Data>,
                                pos: Int,
                                stsus: String
                            ) {
                                when (stsus) {
