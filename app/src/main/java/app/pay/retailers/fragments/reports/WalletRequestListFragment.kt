...
import app.pay.retailers.PaymentRequestDialogFragment
import app.pay.retailers.R
import app.pay.retailers.activity.IntroActivity
import app.pay.retailers.adapters.RequestListAdapter
import app.pay.retailers.adapters.RequestListAdapterDist
import app.pay.retailers.adapters.RequestListAdminAdapter
import app.pay.retailers.databinding.FragmentWalletRequestListBinding
...
import app.pay.retailers.interfaces.RequetWalletClick
import app.pay.retailers.responsemodels.PaymentRequestToAdminResponse
import app.pay.retailers.responsemodels.requestList.Request
import app.pay.retailers.responsemodels.requestList.WalletRequestListResponse

import app.pay.retailers.responsemodels.transferTo.Data
import app.pay.retailers.responsemodels.walletrequestlistsuper.WalletRequestListSuperDist
...
class WalletRequestListFragment : BaseFragment<FragmentWalletRequestListBinding>(FragmentWalletRequestListBinding::inflate) {
    ...
    private lateinit var txnListsuper: MutableList<app.pay.retailers.responsemodels.walletrequestlistsuper.Request>
    var adminList: MutableList<app.pay.retailers.responsemodels.Request> = mutableListOf()
                    ...
                    if (!response.error && response.data.requestList.isNotEmpty()) {
                        ...
                        val clickListner = object : RequetWalletClick {
                            override fun onItemClicked(
                                ...
                                model: List<app.pay.retailers.responsemodels.Request>,
                                pos: Int,
                                amount: String,
                                date: String,
                                status: String,
