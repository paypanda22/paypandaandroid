...
import app.pay.retailers.databinding.FragmentVerifyIdentityBinding
...
import app.pay.retailers.responsemodels.verifypan.VerifyPanResponse
...
class VerifyIdentityFragment : BaseFragment<FragmentVerifyIdentityBinding>(FragmentVerifyIdentityBinding::inflate) {
    ...
    override fun init() {
        ...
        if (userSession.getBoolData(Constant.PAN_VERIFIED)) {
            ...
            binding.tvBtnPan.setText(userSession.getData(Constant.PAN_NUMBER).toString())
