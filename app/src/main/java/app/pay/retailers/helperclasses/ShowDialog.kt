...
import app.pay.retailers.adapters.AepsMsAdapter
import app.pay.retailers.adapters.DmtMakeTxnAdapter
import app.pay.retailers.databinding.DialogAepsBeBinding
import app.pay.retailers.databinding.DialogAepsCwBinding
import app.pay.retailers.databinding.DialogAepsMsBinding
import app.pay.retailers.databinding.DialogFingerResultBinding
import app.pay.retailers.databinding.LytBottomDialogSingleButtonBinding
import app.pay.retailers.databinding.LytBottomDialogTwoButtonBinding
import app.pay.retailers.databinding.LytChangePasswordBinding
import app.pay.retailers.databinding.LytChangePinBinding
import app.pay.retailers.databinding.LytDialogBbpsSuccessBinding
import app.pay.retailers.databinding.LytDialogDmtTxnListBinding
...
import app.pay.retailers.interfaces.MyClickWithString
import app.pay.retailers.responsemodels.dmtTransaction.Data
import app.pay.retailers.responsemodels.forgetPin.ForgetPinResponse
import app.pay.retailers.responsemodels.miniStatement.Ministatement
import app.pay.retailers.responsemodels.pinChange.PasswordChangeResponse
import app.pay.retailers.responsemodels.resendOtpForTpin.resendOtpForTpinResponse
import app.pay.retailers.responsemodels.verifyOtp.VerifyOtpResponse
...
//        }
      ...
      /*  private fun validateMobileOtp(
        ...
        @SuppressLint("SetTextI18n")
        fun aepsBalanceEnq(activity: Activity, model: app.pay.retailers.responsemodels.aepsBe.Data, desc: String, isCashDeposit:Boolean, click: MyClick, click2: MyClick2) {
        ...
        fun aepsMiniStmt(activity: Activity, model: app.pay.retailers.responsemodels.miniStatement.Data, desc: String, click: MyClick) {
            val bottomSheetDialog: Dialog = Dialog(activity)
        ...
        @SuppressLint("SetTextI18n")
        fun aepsCashWithdrawal(activity: Activity, message: String, model: app.pay.retailers.responsemodels.aepsCw.Data, click: MyClick) {
            val bottomSheetDialog: Dialog = Dialog(activity)
...
//                ContextCompat.getDrawable(activity, R.drawable.curved_background_with_shadow)
        ...
        @SuppressLint("SetTextI18n")
        fun bbpsSuccess(activity: Activity, model: app.pay.retailers.responsemodels.billpayresponse.Data, desc: String, click: MyClick) {
            val bottomSheetDialog: Dialog = Dialog(activity)
        ...
        @SuppressLint("SetTextI18n")
        fun cashDepositSuccess(activity: Activity, message:String, model:app.pay.retailers.responsemodels.cashdeposit.Data, click:MyClick) {
            val bottomSheetDialog: Dialog = Dialog(activity)
            val dBinding = DialogAepsCwBinding.inflate(activity.layoutInflater)
            dBinding.root.background =
                ContextCompat.getDrawable(activity, R.drawable.curved_background_with_shadow)
