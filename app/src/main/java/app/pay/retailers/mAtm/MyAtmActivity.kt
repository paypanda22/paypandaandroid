...
import app.pay.retailers.databinding.ActivityMatmBinding
...
import app.pay.retailers.responsemodels.mAtmInit.MAtmTxnInitResponse
    ...
    override fun addListeners() {
        ...
        binding.rgSelectTxnType.setOnCheckedChangeListener { group, checkedId ->
            if (checkedId == R.id.rbCw) {
                ...
                binding.edtAmount.visibility=View.GONE
            ...
            override fun success(from: String, message: String) {
                ...
                if (!response.error) {
                    ...
                    val requestModel = DataModel(
                        transactionAmount = binding.edtAmount.text.toString().takeIf { it.isNotEmpty() }?.toInt() ?: 0,
                        transactionType = txnType.toString(),
                        shop_name = "Siddharth Shop",
                        brand_name = "PayPanda",
