...
interface GetData {
   ...
   // @POST("api/verification/bankVerification")
    ...
    //otpPopup_for-dmt
    @POST("api/dmt/onboardingOtpValidate")
    fun getOnboardingOtpValidate(@Body obj: Any): Call<JsonObject>
 ...
 /*   @GET("https://api.paypandabnk.com/api/aeps/bankList")*/
    ...
    @GET("api/notification/summary/public")
    fun summarynotification(): Call<JsonObject>
...
fun aadhaarPayInvoice(@Path("id") id: String):Call<JsonObject>
    ...
    @GET("api/aeps/bank4Onboarding")
    fun bank4Onboarding(): Call<JsonObject>
   ...
   // @POST("api/general/xml")
    ...
    @GET("api/charges/settings")
    fun settingCharges(): Call<JsonObject>
    ...
    @POST("api/eko/customerKyc")
    fun customerKyc(@Body obj: Any): Call<JsonObject>

    @POST("api/eko/verifyRecipient")
    fun verifyRecipient(@Body obj: Any): Call<JsonObject>

    @POST("api/dmt_txn/dmtTxnSendOtp")
    fun dmtTxnSendOtp(@Body obj: Any): Call<JsonObject>

    @POST("api/eko/paysprintsendotpForRemitter")
    fun paysprintsendotpForRemitter(@Body obj: Any): Call<JsonObject>

    @POST("api/eko/paysprintCreateRemitter")
    fun paysprintCreateRemitter(@Body obj: Any): Call<JsonObject>
