...
class AepsPayoutAdapter(
    ...
    class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
     ...
     //   val tvCustomerMobile: TextView = itemView.findViewById(R.id.tvCustomerMobile)
        ...
        val Beneficiary: TextView = itemView.findViewById(R.id.Beneficiary)
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.Beneficiary.text=list[position].beneid.toString()
        holder.PaymentMode.text=list[position].paymentMode.toString()
