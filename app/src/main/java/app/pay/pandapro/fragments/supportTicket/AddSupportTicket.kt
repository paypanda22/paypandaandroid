...
import app.pay.pandapro.adapters.DisputeMastersAdapter
import app.pay.pandapro.databinding.DialogDisputeMasterBinding
import app.pay.pandapro.databinding.FragmentAddSupportTicketBinding
import app.pay.pandapro.helperclasses.ShowDialog
import app.pay.pandapro.helperclasses.UserSession
import app.pay.pandapro.interfaces.DepartmentClickLickListner
import app.pay.pandapro.interfaces.MCallBackResponse
import app.pay.pandapro.interfaces.MyClick
import app.pay.pandapro.interfaces.PriorityClickLickListner
import app.pay.pandapro.interfaces.ServicesClickLickListner
import app.pay.pandapro.responsemodels.addTicket.AddSupportTicketResponse
import app.pay.pandapro.responsemodels.disputeMaster.Department
import app.pay.pandapro.responsemodels.disputeMaster.DisputeMasterResponse
import app.pay.pandapro.responsemodels.disputeMaster.Priority
import app.pay.pandapro.responsemodels.disputeMaster.Service
...
binding.report.setOnClickListener{
    findNavController().navigate(R.id.SupportTicketListing)
