...
import app.pay.pandapro.databinding.FragmentRegisterBinding
import app.pay.pandapro.databinding.OtpDialogBinding
import app.pay.pandapro.dialog.DialogOK
import app.pay.pandapro.fragments.PrivacyPolicy
import app.pay.pandapro.fragments.RefundPolicyFragment
...
import app.pay.pandapro.responsemodels.registerOtp.RegisterOtpResponse
import app.pay.pandapro.responsemodels.reqestreg.ReqRegistrationResponse
import app.pay.pandapro.responsemodels.statelist.StateListResponse
import app.pay.pandapro.responsemodels.usertype.Data
import app.pay.pandapro.responsemodels.usertype.UserTypeResponse
    ...
    private fun openStateListDialog() {
        ...
        val clickListner = object : StateListClickListner {
            override fun onItemClicked(
                ...
                model: List<app.pay.pandapro.responsemodels.statelist.Data>,
                pos: Int
            ) {
