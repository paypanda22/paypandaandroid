...
import app.pay.pandapro.PaymentRequestDialogFragment
import app.pay.pandapro.R
import app.pay.pandapro.activity.IntroActivity
import app.pay.pandapro.adapters.RequestListAdapter
import app.pay.pandapro.adapters.RequestListAdapterDist
import app.pay.pandapro.adapters.RequestListAdminAdapter
import app.pay.pandapro.databinding.FragmentWalletRequestListBinding
...
import app.pay.pandapro.interfaces.RequetWalletClick
import app.pay.pandapro.responsemodels.PaymentRequestToAdminResponse
import app.pay.pandapro.responsemodels.requestList.Request
import app.pay.pandapro.responsemodels.requestList.WalletRequestListResponse

import app.pay.pandapro.responsemodels.transferTo.Data
import app.pay.pandapro.responsemodels.walletrequestlistsuper.WalletRequestListSuperDist
...
class WalletRequestListFragment : BaseFragment<FragmentWalletRequestListBinding>(FragmentWalletRequestListBinding::inflate) {
    ...
    private lateinit var txnListsuper: MutableList<app.pay.pandapro.responsemodels.walletrequestlistsuper.Request>
    var adminList: MutableList<app.pay.pandapro.responsemodels.Request> = mutableListOf()
                    ...
                    if (!response.error && response.data.requestList.isNotEmpty()) {
                        ...
                        val clickListner = object : RequetWalletClick {
                            override fun onItemClicked(
                                ...
                                model: List<app.pay.pandapro.responsemodels.Request>,
                                pos: Int,
                                amount: String,
                                date: String,
                                status: String,
