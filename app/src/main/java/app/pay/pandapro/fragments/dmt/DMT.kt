...
import app.pay.pandapro.databinding.LytDialogAddRecipientBinding
import app.pay.pandapro.databinding.LytFinalDmtBinding
import app.pay.pandapro.databinding.LytRvNameSearchItemListBinding
...
import app.pay.pandapro.responsemodels.addRecipient.AddRecipientResponse
...
import app.pay.pandapro.responsemodels.dmtTransaction.DMTMakeTransactionResponse
import app.pay.pandapro.retrofit.Constant
import app.pay.pandapro.retrofit.UtilMethods
import app.pay.pandapro.reusable.Utills.setOnTextChangedListener
...
class DMT(
    ...
    fun openMakeTransactionDialog(
        recipient: app.pay.pandapro.responsemodels.dmtBeneficiaryList.Data,
        avlLimit: Int,
        customerName: String,
    ...
    private fun validateBeneficiaryAfter(dBinding: LytFinalDmtBinding, recipient: app.pay.pandapro.responsemodels.dmtBeneficiaryList.Data) {
    ...
    private fun dmtTxnListDialog(response: DMTMakeTransactionResponse, dmtDialog: Dialog) {
        dmtDialog.dismiss()
        val list = ArrayList<app.pay.pandapro.responsemodels.dmtTransaction.Data>()
