...
import app.pay.pandapro.adapters.WalletTxnAdapter
...
import app.pay.pandapro.responsemodels.walletTxn.Wallet
import app.pay.pandapro.responsemodels.walletTxn.WalletTxnReportResponse
...
class WalletTransactionReport : BaseFragment<FragmentWalletTransactionReportBinding>(FragmentWalletTransactionReportBinding::inflate) {
    ...
    override fun addListeners() {
        ...
        binding.rgCount.setOnCheckedChangeListener { group, checkedId ->
            when (checkedId) {
                app.pay.pandapro.R.id.rb25 -> {
                    count = 25
                }

                app.pay.pandapro.R.id.rb50 -> {
                    count =50
                }

                app.pay.pandapro.R.id.rb100 -> {
                    count = 100
                }

                app.pay.pandapro.R.id.rb150 -> {
                    count = 150
                }

                app.pay.pandapro.R.id.rb200 -> {
                    count = 200
                }
                app.pay.pandapro.R.id.more -> {
                    count=900
                }
            }
        }
