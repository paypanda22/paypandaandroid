...
import app.pay.pandapro.adapters.PackageListAdapter
import app.pay.pandapro.adapters.PackagePriceAdapter
import app.pay.pandapro.databinding.FragmentPackageListBinding
import app.pay.pandapro.databinding.LytDialogPackagePricingBinding
...
import app.pay.pandapro.interfaces.PackageListClickListener
import app.pay.pandapro.interfaces.PackagePriceClick
import app.pay.pandapro.responsemodels.PackagePrizeDataDeserializer
import app.pay.pandapro.responsemodels.PostApiResponse
...
import app.pay.pandapro.responsemodels.packageListResponse.Price
import app.pay.pandapro.responsemodels.realvalueresponse.RealValueResponse
...
class PackageListFragment : BaseFragment<FragmentPackageListBinding>(FragmentPackageListBinding::inflate), PackageListClickListener,
    ...
    var real_prize=""
    private lateinit var txnDetailList:MutableList<app.pay.pandapro.responsemodels.packagedetail.Data>
    private lateinit var txnDetail:MutableList<app.pay.pandapro.responsemodels.realvalueresponse.Price>
    override fun init() {
        nullActivityCheck()
...
*/
    override fun onPriceSelected(
        ...
        model: List<app.pay.pandapro.responsemodels.realvalueresponse.Price>,
        pos: Int
    ) {
        val selectedPrice = model[pos]
        package_price = selectedPrice._id.toString()
