...
interface ZSMDownStreamClick {
    ...
    fun onViewWalletReportClicked(holder: ZsmDownStreamAdapter.ViewHolder, downstramlist: MutableList<app.pay.pandapro.responsemodels.zsmresponse.Data>, position: Int)
