package app.pay.pandapro.sqlitehelper
...
class CategoryDatabaseHelper(context: Context) : SQLiteOpenHelper(context, DATABASE_NAME, null, DATABASE_VERSION) {
    ...
    fun insertCategory(dataList: List<app.pay.pandapro.responsemodels.allservices.Data>): Long {
    ...
    fun getAllCategories(): List<app.pay.pandapro.responsemodels.allservices.Data> {
        val categoryList: MutableList<app.pay.pandapro.responsemodels.allservices.Data> = mutableListOf()
        ...
        if (cursor.moveToFirst()) {
            do {
                val category = app.pay.pandapro.responsemodels.allservices.Data(
