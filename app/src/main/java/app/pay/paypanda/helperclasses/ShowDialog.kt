...
import app.pay.paypanda.adapters.AepsMsAdapter
import app.pay.paypanda.adapters.DmtMakeTxnAdapter
import app.pay.paypanda.databinding.DialogAepsBeBinding
import app.pay.paypanda.databinding.DialogAepsCwBinding
import app.pay.paypanda.databinding.DialogAepsMsBinding
import app.pay.paypanda.databinding.DialogFingerResultBinding
import app.pay.paypanda.databinding.LytBottomDialogSingleButtonBinding
import app.pay.paypanda.databinding.LytBottomDialogTwoButtonBinding
import app.pay.paypanda.databinding.LytChangePasswordBinding
import app.pay.paypanda.databinding.LytChangePinBinding
import app.pay.paypanda.databinding.LytDialogBbpsSuccessBinding
import app.pay.paypanda.databinding.LytDialogDmtTxnListBinding
import app.pay.paypanda.databinding.OtpDialogBinding
...
import app.pay.paypanda.interfaces.MyClickWithString
import app.pay.paypanda.responsemodels.dmtTransaction.Data
import app.pay.paypanda.responsemodels.forgetPin.ForgetPinResponse
import app.pay.paypanda.responsemodels.miniStatement.Ministatement
import app.pay.paypanda.responsemodels.pinChange.PasswordChangeResponse
import app.pay.paypanda.responsemodels.resendOtpForTpin.resendOtpForTpinResponse
...
//        }
      ...
      /*  private fun validateMobileOtp(
        ...
        @SuppressLint("SetTextI18n")
        fun aepsBalanceEnq(activity: Activity, model: app.pay.paypanda.responsemodels.aepsBe.Data, desc: String, isCashDeposit:Boolean, click: MyClick, click2: MyClick2) {
        ...
        fun aepsMiniStmt(activity: Activity, model: app.pay.paypanda.responsemodels.miniStatement.Data, desc: String, click: MyClick) {
            val bottomSheetDialog: Dialog = Dialog(activity)
        ...
        @SuppressLint("SetTextI18n")
        fun aepsCashWithdrawal(activity: Activity, message: String, model: app.pay.paypanda.responsemodels.aepsCw.Data, click: MyClick) {
            val bottomSheetDialog: Dialog = Dialog(activity)
...
//                ContextCompat.getDrawable(activity, R.drawable.curved_background_with_shadow)
        ...
        @SuppressLint("SetTextI18n")
        fun bbpsSuccess(activity: Activity, model: app.pay.paypanda.responsemodels.billpayresponse.Data, desc: String, click: MyClick) {
            val bottomSheetDialog: Dialog = Dialog(activity)
        ...
        @SuppressLint("SetTextI18n")
        fun cashDepositSuccess(activity: Activity, message:String, model:app.pay.paypanda.responsemodels.cashdeposit.Data, click:MyClick) {
            val bottomSheetDialog: Dialog = Dialog(activity)
            val dBinding = DialogAepsCwBinding.inflate(activity.layoutInflater)
            dBinding.root.background =
                ContextCompat.getDrawable(activity, R.drawable.curved_background_with_shadow)
