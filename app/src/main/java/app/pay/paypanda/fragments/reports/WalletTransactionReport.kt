...
import app.pay.paypanda.adapters.WalletTxnAdapter
import app.pay.paypanda.databinding.FragmentWalletTransactionReportBinding
...
import app.pay.paypanda.responsemodels.walletTxn.WalletTxnReportResponse
...
class WalletTransactionReport : BaseFragment<FragmentWalletTransactionReportBinding>(FragmentWalletTransactionReportBinding::inflate) {
    ...
    override fun addListeners() {
        ...
        binding.rgCount.setOnCheckedChangeListener { group, checkedId ->
            when (checkedId) {
                app.pay.paypanda.R.id.rb25 -> {
                    count = 25
                }

                app.pay.paypanda.R.id.rb50 -> {
                    count =50
                }

                app.pay.paypanda.R.id.rb100 -> {
                    count = 100
                }

                app.pay.paypanda.R.id.rb150 -> {
                    count = 150
                }

                app.pay.paypanda.R.id.rb200 -> {
                    count = 200
                }
                app.pay.paypanda.R.id.more -> {
                    count=900
                }
            }
        }
