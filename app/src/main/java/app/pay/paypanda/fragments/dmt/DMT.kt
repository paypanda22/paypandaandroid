...
import app.pay.paypanda.adapters.DmtBankAdapter
import app.pay.paypanda.databinding.FragmentDMTBinding
import app.pay.paypanda.databinding.LytDialogAddRecipientBinding
import app.pay.paypanda.databinding.LytFinalDmtBinding
import app.pay.paypanda.databinding.LytRvNameSearchItemListBinding
...
import app.pay.paypanda.responsemodels.addRecipient.AddRecipientResponse
import app.pay.paypanda.responsemodels.bankverification.BankVerifictionResponse
import app.pay.paypanda.responsemodels.cmsinvoice.CMSInvoiceResponse
import app.pay.paypanda.responsemodels.dmtBankList.DMTBankListResponse
import app.pay.paypanda.responsemodels.dmtBankList.Data
import app.pay.paypanda.responsemodels.dmtTransaction.DMTMakeTransactionResponse
import app.pay.paypanda.retrofit.Constant
import app.pay.paypanda.retrofit.UtilMethods
import app.pay.paypanda.reusable.Utills.setOnTextChangedListener
...
class DMT(
    ...
    fun openMakeTransactionDialog(
        recipient: app.pay.paypanda.responsemodels.dmtBeneficiaryList.Data,
        avlLimit: Int,
        customerName: String,
    ...
    private fun validateBeneficiaryAfter(dBinding: LytFinalDmtBinding, recipient: app.pay.paypanda.responsemodels.dmtBeneficiaryList.Data) {
    ...
    private fun dmtTxnListDialog(response: DMTMakeTransactionResponse, dmtDialog: Dialog) {
        dmtDialog.dismiss()
        val list = ArrayList<app.pay.paypanda.responsemodels.dmtTransaction.Data>()
