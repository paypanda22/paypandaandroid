...
import app.pay.paypanda.adapters.CMSReportAdapter
import app.pay.paypanda.databinding.FragmentCMSTransactionReportBinding
...
import app.pay.paypanda.interfaces.CMSInvoicClick
...
import app.pay.paypanda.responsemodels.cmsreportresponse.CMSReportResponse
...
class CMSTransactionReport : BaseFragment<FragmentCMSTransactionReportBinding>(FragmentCMSTransactionReportBinding::inflate) {
    ...
    private lateinit var cmslist:MutableList<app.pay.paypanda.responsemodels.cmsreportresponse.Data>
    override fun init() {
        nullActivityCheck()
                    ...
                    if (response.data.isNotEmpty()) {
                        ...
                        val clickListner = object : CMSInvoicClick {
                            override fun onItemClicked(
                                ...
                                model: List<app.pay.paypanda.responsemodels.cmsreportresponse.Data>,
                                pos: Int,
                                stsus: String
                            ) {
                                when (stsus) {
