...
import app.pay.paypanda.adapters.PackageReportAdapter
import app.pay.paypanda.databinding.FragmentPackageHistoryReportBinding
...
import app.pay.paypanda.responsemodels.packagehistory.Data
import app.pay.paypanda.responsemodels.packagehistory.PackageHistoryReportResponse
...
class PackageHistoryReport : BaseFragment<FragmentPackageHistoryReportBinding>(FragmentPackageHistoryReportBinding::inflate) {
    ...
    private lateinit var packageList: MutableList<app.pay.paypanda.responsemodels.packageListResponse.Data>
