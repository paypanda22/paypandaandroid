...
import app.pay.paypanda.adapters.CategoryAdapter
import app.pay.paypanda.adapters.CategoryIDAdapter
import app.pay.paypanda.adapters.UtilityTransactionAdapter
import app.pay.paypanda.databinding.DialogCategoryListBinding
import app.pay.paypanda.databinding.FragmentUtilityTransactionsBinding
import app.pay.paypanda.databinding.LytUtilityFilterBinding
...
import app.pay.paypanda.interfaces.BbpsCategoryClick
import app.pay.paypanda.interfaces.BbpsCategoryIDClick
import app.pay.paypanda.interfaces.MCallBackResponse
import app.pay.paypanda.interfaces.UtilityTransactionClick

import app.pay.paypanda.responsemodels.bbpscatagory.CatagoryListResponse
import app.pay.paypanda.responsemodels.bbpsenquiry.BbpsEnquiry

import app.pay.paypanda.responsemodels.utilitytxn.Data

import app.pay.paypanda.responsemodels.utilitytxn.UtilityTxnResponse
...
class UtilityTransactions : BaseFragment<FragmentUtilityTransactionsBinding>(FragmentUtilityTransactionsBinding::inflate){
    ...
    private lateinit var cateList:MutableList<app.pay.paypanda.responsemodels.bbpscatagory.Data>
    private lateinit var cateListId:MutableList<app.pay.paypanda.responsemodels.CategoryIdResponse.Data>
...
dBinding.edtBillers.setOnClickListener{
    ...
    private fun openServiceTypeListDialog(edtServiceType: EditText,lytBillerName: TextInputLayout,tagValueId:String) {
        ...
        val clickListener = object : BbpsCategoryClick {
            override fun onItemClicked(holder: RecyclerView.ViewHolder, model: List<app.pay.paypanda.responsemodels.bbpscatagory.Data>, pos: Int) {
    ...
    private fun openServiceTypeListDialogId(edtBillers: EditText) {
        ...
        val click = object : BbpsCategoryIDClick {
            override fun onItemClickedId(holder: RecyclerView.ViewHolder, model: List<app.pay.paypanda.responsemodels.CategoryIdResponse.Data>, pos: Int) {
