...
import app.pay.paypanda.PaymentRequestDialogFragment
import app.pay.paypanda.R
import app.pay.paypanda.activity.IntroActivity
import app.pay.paypanda.adapters.RequestListAdapter
import app.pay.paypanda.adapters.RequestListAdapterDist
import app.pay.paypanda.adapters.RequestListAdminAdapter
import app.pay.paypanda.databinding.FragmentWalletRequestListBinding
...
import app.pay.paypanda.responsemodels.PaymentRequestToAdminResponse
import app.pay.paypanda.responsemodels.requestList.Request
import app.pay.paypanda.responsemodels.requestList.WalletRequestListResponse

import app.pay.paypanda.responsemodels.transferTo.Data
import app.pay.paypanda.responsemodels.walletrequestlistsuper.WalletRequestListSuperDist
...
class WalletRequestListFragment : BaseFragment<FragmentWalletRequestListBinding>(FragmentWalletRequestListBinding::inflate) {
    ...
    private lateinit var txnListsuper: MutableList<app.pay.paypanda.responsemodels.walletrequestlistsuper.Request>
    var adminList: MutableList<app.pay.paypanda.responsemodels.Request> = mutableListOf()
            ...
            override fun success(from: String, message: String) {
                ...
                if (!response.error) {
                    ...
                    if (txnList.isNotEmpty()) {
                        ...
                        // If requestList is empty and totalCount is 0, show no data view
                    ...
                    if (!response.error && response.data.requestList.isNotEmpty()) {
                        ...
                        val clickListner = object : RequetWalletClick {
                            override fun onItemClicked(
                                ...
                                model: List<app.pay.paypanda.responsemodels.Request>,
                                pos: Int,
                                amount: String,
                                date: String,
                                status: String,
    ...
    override fun addListeners() {
        ...
        binding.rbLoginMethod.setOnClickListener { view ->
            ...
            popup.setOnMenuItemClickListener { item: MenuItem ->
                ...
                when (item.itemId) {
                    R.id.Company -> {
                        getWalletRequestList(start_date,end_date,selectedItem,count)
                        true
                    }
