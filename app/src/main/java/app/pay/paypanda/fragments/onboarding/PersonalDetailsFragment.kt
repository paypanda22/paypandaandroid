...
import app.pay.paypanda.adapters.CountryListAdapter
import app.pay.paypanda.adapters.StateListAdapter
import app.pay.paypanda.databinding.FragmentPersonalDetailsBinding
...
import app.pay.paypanda.interfaces.CountryListClickListner
...
import app.pay.paypanda.responsemodels.aadhaarAddress.AadhaarAddressResponse
import app.pay.paypanda.responsemodels.countrylist.CountryListResponse
...
class PersonalDetailsFragment : BaseFragment<FragmentPersonalDetailsBinding>(FragmentPersonalDetailsBinding::inflate) {
    ...
    private fun openStateListDialog() {
        ...
        val clickListner = object : StateListClickListner {
            override fun onItemClicked(holder: RecyclerView.ViewHolder, model: List<app.pay.paypanda.responsemodels.statelist.Data>, pos: Int) {
