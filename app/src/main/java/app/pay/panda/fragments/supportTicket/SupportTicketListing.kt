    ...
    class SupportTicketListing : BaseFragment<FragmentSupportTicketListingBinding>(FragmentSupportTicketListingBinding::inflate), SupportTicketClick ,OnFilterSubmitListener {
        ...
        override fun init() {
            ...
            getSupportTickets("", "", "" ?: "", "" ?: "", "" ?: "", 25)

        }

        private fun getSupportTickets(startDate: String?,endDate: String?,selectedDepartment:String,selectedPriority:String,selectedStatus:String,count: Int) {
        ...
        override fun onFilterSubmit(
            ...
            getSupportTickets(startDate,endDate,department,priority,status,count)
        }
