...
import app.pay.panda.adapters.PackageReportAdapter
import app.pay.panda.databinding.FragmentPackageHistoryReportBinding
...
import app.pay.panda.responsemodels.packagehistory.Data
import app.pay.panda.responsemodels.packagehistory.PackageHistoryReportResponse
...
class PackageHistoryReport : BaseFragment<FragmentPackageHistoryReportBinding>(FragmentPackageHistoryReportBinding::inflate) {
    ...
    private lateinit var packageList: MutableList<app.pay.panda.responsemodels.packageListResponse.Data>
            ...
            override fun success(from: String, message: String) {
                ...
                if (!response.error) {
                    ...
                    if (response.data.isNotEmpty()) {
                        ...
                        binding.imageView.visibility = VISIBLE  // Assuming this is part of the "No Data Found" layout
                    }
                } else {
                    binding.rvDmtTransactions.visibility = GONE
                    binding.llNoData.visibility = VISIBLE
